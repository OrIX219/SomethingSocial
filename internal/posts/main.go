...
import (
	...
	"github.com/OrIX219/SomethingSocial/internal/posts/ports"
	"github.com/OrIX219/SomethingSocial/internal/posts/service"
...
func main() {
	...
	case "grpc":
		server.RunGRPCServer(func(server *grpc.Server) {
			...
			posts.RegisterPostsServiceServer(server, srv)
		})
	}
}
